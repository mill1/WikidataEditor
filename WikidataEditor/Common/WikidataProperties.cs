namespace WikidataEditor.Common
{
    public static class WikidataProperties
    {
        ...
        public static readonly Dictionary<string, string> Labels = new Dictionary<string, string>
        {
            ...
            { "P10995","national-football-teams.com ID" },
            { "P10996","TGbus ID" },
            ...
            { "P11535","Dictionary of Frequently-Used Taiwan Minnan ID" },
            ...
            { "P11546","Los Angeles County Coroner's Office Case Search person ID" },
            ...
            { "P11571","federal identifier of street" },
            ...
            { "P11666","Norwegian Petroleum Directorate field ID" },
            ...
            { "P11893","Dutch language word list ID" },
