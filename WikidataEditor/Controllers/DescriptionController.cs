...
namespace WikidataEditor.Controllers
{
    ...
    public class DescriptionController : ControllerBase
    {
        ...
        {
            // John Fleming: http://localhost:38583/api/items/Q15429542/descriptions
        ...
        {
            // John Fleming: http://localhost:38583/api/items/Q15429542/descriptions/languagecodes/en
        ...
        {
            // Lesley Cunliffe: http://localhost:38583/api/items/descriptions?id=Q99589194&languagecode=en
        ...
        {
            // http://localhost:38583/api/items/description/upsert/?id=Kaboom123&languagecode=en&description=some+description
