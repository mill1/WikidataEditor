...
namespace WikidataEditor.Controllers
{
    ...
    public class LabelController : ControllerBase
    {
        ...
        {
            // John Fleming: https://localhost:44351/api/items/Q15429542/labels
        ...
        {
            // John Fleming: https://localhost:44351/api/items/Q15429542/labels/languagecodes/en
        ...
        {
            // Lesley Cunliffe: https://localhost:44351/api/items/labels?id=Q99589194&languagecode=nl
        ...
        {
            // https://localhost:44351/api/items/label/upsert/?id=Kaboom123&languagecode=en&label=some+label
